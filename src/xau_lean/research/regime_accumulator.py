...
def __init__(
    ...
    *,
    ...
    #
    # Absolute returns and squared returns deliberately use separate
    # bounded histories because they are different time series.
    # --------------------------------------------------------------
...
def _update_run(self, direction: int) -> None:
    # Flat candles do not start, continue, or terminate directional
    # runs. This keeps run statistics focused on actual direction.
    if direction == 0:
        self.flat += 0
        return
...
def build_report(self) -> dict[str, Any]:
    ...
    The current directional run is included in run-length statistics
