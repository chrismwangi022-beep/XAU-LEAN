...
class SyntheticData(PythonData):

    def GetSource(self, config, date, isLive):

        path = (
            Path("/Lean/workspace")
            / "data/external/dukascopy/test/synthetic_10.csv"
        )
...
class PythonDataSyntheticTest(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.Debug("========================================")
        self.Debug("PYTHONDATA SYNTHETIC TEST")
